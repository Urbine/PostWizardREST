...
/**
 * Custom exception to indicate that a record identifier is invalid.
 * This exception is thrown when an operation attempts to access or manipulate
 * a record with an identifier that does not exist or is malformed.
 * * <p>
 * It extends {@link RuntimeException} to allow for unchecked exceptions
 * and can be used in various parts of the application
 * to signal issues with record identifiers.
 * 
...
public class InvalidIdentifier extends RuntimeException {
	...
	public InvalidIdentifier(String message, Throwable cause, boolean enableSuppression,
