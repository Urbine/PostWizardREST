...
import net.ygbstudio.postdirector.exceptions.LoggingException;

/**
 * Exception mapper for handling LoggingException in the PostDirector application. This class
 * converts LoggingException into a standardized HTTP response.
 *
