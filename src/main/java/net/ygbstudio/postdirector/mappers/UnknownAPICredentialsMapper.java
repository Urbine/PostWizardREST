...
/**
 * Exception mapper for handling UnknownAPICredentials exceptions.
 * This class converts UnknownAPICredentials exceptions into HTTP responses
...
public class UnknownAPICredentialsMapper implements ExceptionMapper<UnknownAPICredentials> {
	 ...
	 * @return a | Response object with a 401 Unauthorized status and an error
	 *         message
	 */
	@Override
	public Response toResponse(UnknownAPICredentials ex) {

		ErrorResponse authError = new ErrorResponse("No API Credentials were found or this request is unauthorized",
				ex.getMessage(),
